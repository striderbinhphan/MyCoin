...
const initVirtualBlockChainData = () => {
    ...
    const tx1 = new Transaction(null,myAddress,100);
    tx1.signTransaction(null);
    binhcoin.addTransaction(tx1);
    const tx2 = new Transaction(null,othersAddress,100);
    ...
    const tx3 = new Transaction(myAddress,othersAddress,10);
    ...
    const tx4 = new Transaction(myAddress,othersAddress,10);
    ...
    const tx5 = new Transaction(myAddress,othersAddress,10);
    ...
    const tx6 = new Transaction(myAddress,othersAddress,10);
    ...
    const tx7 = new Transaction(myAddress,othersAddress,10);
    ...
    const tx8 = new Transaction(myAddress,othersAddress,10);
    ...
    const tx9 = new Transaction(myAddress,othersAddress,10);
    ...
    const tx10 = new Transaction(myAddress,othersAddress,10);
    ...
    const tx11 = new Transaction(myAddress,othersAddress,10);
    ...
    const tx12 = new Transaction(myAddress,othersAddress,10);
